...
type BarConstant = { backgroundColor: string, barColor: string, width?: string, height: string, placement?: string, rounded: string };
type CircleConstant = { size: number, borderWidth: number, backgroundColor: string, barColor: string, alwaysFullBackgroundColor?: string, alwaysFullColor?: string };
const BAR_CONSTANTS: { [ key: number ]: BarConstant | CircleConstant } = {
  ...
  [ ResourceType.MP ]: { backgroundColor: 'bg-blueDark/30', barColor: 'bg-blue', width: 'w-[52%]', height: 'h-[10%]', placement: 'self-end', rounded: 'rounded-sm' },
  [ ResourceType.SP ]: { backgroundColor: 'bg-yellowDark/30', barColor: 'bg-yellow', width: 'w-[52%]', height: 'h-[10%]', rounded: 'rounded-sm' },
  
  [ ResourceType.EXP ]: { size: 16, borderWidth: 1.5, backgroundColor: 'stroke-yellow/30', barColor: 'stroke-yellow' },
  [ ResourceType.QUEST ]: { size: 16, borderWidth: 1.5, backgroundColor: 'stroke-cyanDark/30', barColor: 'stroke-cyan', alwaysFullBackgroundColor: 'stroke-greenDark/30', alwaysFullColor: 'stroke-green' }
};
...
export const ProgressCircle = ( {
  ...
  const { barColor, backgroundColor, alwaysFullColor, alwaysFullBackgroundColor, borderWidth, size } = circleData as CircleConstant;
